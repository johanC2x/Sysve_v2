...
<div class="row">
    <div class="col-md-12">
        ...
        <h4 class="modal-title">Cotizacion Nro: <span id="modal-title-coti"><?php echo $cotizacion_id;?></span><span id="modal-coti"><?php echo "-".$estatus;?></span></h4>
        </div>
    </div>
</div>
<hr/>
    ...
    <?php if (isset($datos)): ?>
            <form role="form" id="datos_cotizacion">
                <div class="col-md-2" class="form-group">
                  ...
                  //      print_r($datos);
                     ?>
                    <input type="text" id="customer_documents_id" name="customer_document_id" value="<?php echo $datos["documents"] //echo $datos['person_id']; ?>" class="form-control" disabled/>
                </div>
...
<div class="row">
    <div class="col-md-12">
        <?php echo form_open('travel/cotizaciones'); ?>
            ...
            <input type="hidden" id="customer_documents" name="customer_documents" value="<?php echo $datos['person_id']; ?>" />
            <fieldset>
...
<!--                    <div class="col-md-3" class="form-group">
                        ...
                        <input type="text" name="cbo_comision_payment_children" id="cbo_comision_payment_children" class="form-control" disabled/>
                    </div>
...
-->
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="button" id="btn_save_com_children" class="btn btn-primary" value="Agregar"/>
                    </div>
