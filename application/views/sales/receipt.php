...
<div id="modal_agregar" class="modal fade" role="dialog" data-backdrop="static" aria-hidden="true" tabindex="-1" style="overflow-y: scroll;">
    <div class="modal-dialog modal-lg">
        ...
        <?php echo form_open('sales/ventas');?>
                        ...
                        <input type="hidden" id="venta_data" name="venta_data"/>
...
<!--============================== INICIO SUB TOTALES======================-->
        ...
        <dir class="modal-header" style="background-color:#90B3B3">        
                ...
                <div class="col-md-2">
                  <div class="form-group" >
                    <label for="porcentaje">% Util.</label>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <fieldset>
                ...
                <div class="col-md-2" class="form-group">
                    <label for="incentivo">Incentivo:</label>
                    <input type="text" name="incentivo" id="incentivo" class="form-control" autocomplete="off" />
                </div>
              </fieldset>
            </div>
      </div>
