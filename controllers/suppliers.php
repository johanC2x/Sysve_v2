	...
	function save($supplier_id=-1)
	{
		if($this->input->post('first_name') != ""
		   ...
		   and $this->input->post('phone_number') != ""){
			...
			echo json_encode(array('success'=>false,'message'=>$this->lang->line('No se deben ingresar campos vacios Email / Nombre / Numero de Telefono')));
		} 
		redirect('/suppliers/index','index'); 
	}
