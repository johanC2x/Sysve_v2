...
function getMessageSuccess(msg){ 
	var html = "";
...
function clearTable(obj,colspan,msg){
	$('#'+obj+' tr td').remove();
	$('#'+obj).append('<tr><td colspan="'+colspan+'"><div id="msg_empty_kit" class="warning_message" style="padding:7px;">'+msg+'</div></td></tr>');
}
