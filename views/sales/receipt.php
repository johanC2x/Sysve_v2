...
<div id="receipt_wrapper">
	...
	<?php } ?>
		<tr>
			<td colspan="4" style='text-align:right;border-top:2px solid #000000;'>
				<?php echo $this->lang->line('sales_sub_total'); ?> 
			</td>
			<td colspan="2" style='text-align:right;border-top:2px solid #000000;'>
	...
	<?php //foreach($payments as $payment_id=>$payment){ ?>
		...
		<tr>
			...
			<td colspan="2" style="text-align:right">
				<?php //echo to_currency( $payment['payment_amount'] * -1 ); ?>  
			</td>
	    </tr>
		-->
	<?php //} ?>
		...
		<tr>
			<td colspan="4" style='text-align:right;'>
				<?php //echo $this->lang->line('sales_change_due'); ?> 
			</td>
			<td colspan="2" style='text-align:right'>
				<?php //echo  $amount_change; ?> 
			</td>
		</tr>
		-->
	</table>
